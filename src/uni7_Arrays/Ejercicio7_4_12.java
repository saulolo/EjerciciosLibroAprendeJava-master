 ...
 * posiciones a las que llamaremos “inicial” y “final”. Se debe comprobar que inicial es menor que
 * final y que ambos números están entre 0 y 9. El programa deberá colocar el número de la posición
 * inicial en la posición final, rotando el resto de números para que no se pierda ninguno. Al final
 * se debe mostrar el array resultante.
 * Por ejemplo, para inicial = 3 y final = 7:
 * @author Saulolo
 */
public class Ejercicio7_4_12 {

    public static void main(String[] args)  {

        Scanner input = new Scanner(System.in);

        String into = ("MOSTRANDO ARRAY DESDE UN INICIAL Y UN FINAL");
