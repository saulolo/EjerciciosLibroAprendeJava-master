 ...
 * al índice (0 – 9). Seguidamente el programa debe colocar de forma alterna y en orden los menores
 * o iguales de 100 y los mayores de 100: primero menor, luego mayor, luego menor, luego mayor…
 * Cuando se acaben los menores o los mayores, se completará con los números que queden.
 * @author Saulolo
 */
public class Ejercicio7_4_18 {

    public static void main(String[] args)  {

        String into = ("MOSTRANDO CONTENIDO ARRAY JUNTO AL INDICE");
